...
let styles = StyleSheet.create({
  container: {
    flex: 1,
    position: 'absolute',
    width: SIZE * screenDim.width,
    height: SIZE * screenDim.height,
    backgroundColor: 'transparent',
    top: -screenDim.height,
...
export class Area extends Component {
  ...
  // componentWillUpdate (nextProps, nextState) {
    ...
    // console.log('@@@@$$$$@@@@@AREA componentWillReceiveProps ',
    // 'this.state.paths',
    // this.state.paths, 
    // 'nextState.paths',
    // nextState.paths,
  ...
  render() {
    ...
    // console.log('!!!~~~~~~~~RENDERING AREA~~~~~~',{styles})
